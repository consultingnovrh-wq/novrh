-- Migration finale pour corriger définitivement les problèmes RLS
...
-- Supprimer les politiques pour candidates
...
-- Supprimer les politiques pour companies
...
-- 2. Corriger la table profiles - ajouter les colonnes manquantes
...
-- 3. Mettre à jour la contrainte user_type pour inclure tous les types
ALTER TABLE public.profiles 
...
-- 4. Créer des politiques RLS simples et permissives pour profiles
...
-- 7. Ajouter des politiques pour les administrateurs
