-- Migration finale pour corriger le type user_type
...
-- 6. Modifier la colonne user_type pour utiliser le type ENUM
DO $$
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.columns 
        ...
        USING CASE 
            WHEN user_type = 'employer' THEN 'company'::user_type
            WHEN user_type = 'student' THEN 'candidate'::user_type
            WHEN user_type = 'admin' THEN 'admin'::user_type
            WHEN user_type = 'company' THEN 'company'::user_type
            WHEN user_type = 'candidate' THEN 'candidate'::user_type
            ELSE 'candidate'::user_type
        END;
        
        RAISE NOTICE 'Colonne user_type convertie en ENUM';
    ELSE
