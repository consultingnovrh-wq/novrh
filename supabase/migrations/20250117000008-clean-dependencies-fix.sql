-- Migration pour corriger le type user_type en gérant les dépendances
...
-- 6. Supprimer toutes les politiques RLS qui dépendent de user_type
...
-- 7. Supprimer toutes les autres politiques sur profiles
...
-- 8. Gérer la colonne user_type de manière sécurisée
DO $$
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.columns 
        ...
        RAISE NOTICE 'Colonne user_type existante supprimée avec CASCADE';
    END IF;
...
-- 9. Recréer la fonction handle_new_user avec le bon cast
...
-- 10. Recréer la fonction handle_user_update avec le bon cast
...
-- 12. Synchroniser les utilisateurs existants avec le bon cast
INSERT INTO public.profiles (
  user_id,
  email,
  first_name,
...
-- 13. Recréer des politiques RLS simples pour les administrateurs
